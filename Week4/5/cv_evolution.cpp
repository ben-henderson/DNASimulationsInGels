...
*/
    ...
    //First bp at the beggining of arm4:
    int id1a4=??;
    int id2a4=??;
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        {            
            ...
            c4[d] = (com[t][d][id1a4-1] + com[t][d][id2a4-1])/2.0;
            c5[d] = (com[t][d][id1a5-1] + com[t][d][id2a5-1])/2.0;
        }
                
        //COM of the molecule at the core
        for(int d=0; d<3; d++)
        { 
            core[t][d] = (c1[d] + c2[d] + c3[d] + c4[d] + c5[d])/5.0;
        }
    ...
    vector<vector <double> > dsdna4(frames, vector<double>(3));
    vector<vector <double> > dsdna5(frames, vector<double>(3));
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        vector <double> c4end(3);
        vector <double> c5end(3);
        ...
        {            
            ...
            c4end[d] = (com[t][d][id1a4end-1] + com[t][d][id2a4end-1])/2.0;
            c5end[d] = (com[t][d][id1a5end-1] + com[t][d][id2a5end-1])/2.0;
        }
        ...
        for(int d=0; d<3; d++)
        {
            ...
            v4[d] = c4end[d] - core[t][d];
            v5[d] = c5end[d] - core[t][d];
        }
        ...
        double dd4=sqrt(v4[0]]*v4[0] + v4[1]*v4[1] + v4[2]*v4[2]);
        double dd5=sqrt(v5[0]]*v5[0] + v5[1]*v5[1] + v5[2]*v5[2]);
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        double dx=dsdna4[t][0];   double dy=dsdna4[t][1];   double dz=dsdna4[t][2];
        double ex=dsdna5[t][0];   double ey=dsdna5[t][1];   double ez=dsdnae[t][2];
        
        vector<double> A1 {ax, ay, az};
        vector<double> A2 {bx, by, bz};
        vector<double> A3 {cx, cy, cz};
        vector<double> A4 {dx, dy, dz};
        vector<double> A5 {ex, ey, ez};
        ...
        AB=crossProduct(A1,A2);
        AC=crossProduct(A1,A3);
        AD=crossProduct(A1,A4);
        AE=crossProduct(A1,A5);
        BC=crossProduct(A2,A3);
        BD=crossProduct(A2,A4);
        BE=crossProduct(A2,A5);
        CD=crossProduct(A3,A4);
        CE=crossProduct(A3,A5);
        DE=crossProduct(A4,A5);
    ...
    vector<double> dist4(frames);
    vector<double> dist5(frames);
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        for(int d=0; d<3; d++)
        {
            ...
            l3 += pow(com[t][d][id1a4-1] - com[t][d][id2a4-1],2.0);
            l4 += pow(com[t][d][id1a5-1] - com[t][d][id2a5-1],2.0);
        }
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        double cx=dsdna3[t][0];   double cy=dsdna3[t][1];   double cz=dsdna3[t][2];
        double dx=dsdna4[t][0];   double dy=dsdna4[t][1];   double dz=dsdna4[t][2];
        double ex=dsdna5[t][0];   double ey=dsdna5[t][1];   double ez=dsdna5[t][2];
    ...
    vector<double> theta13(frames);
    vector<double> theta15(frames);
    vector<double> theta23(frames);
    vector<double> theta24(frames);
    vector<double> theta25(frames);
    vector<double> theta34(frames);
    vector<double> theta35(frames);
    vector<double> theta45(frames);
    ...
    for (int t=0; t<frames; t++)
    {
        ...
        //unitary dsDNA arm5
        vector<double> A5 {dx, dy, dz};
        
        //DOt products
        double ctheta12 = dotProduct(A1,A2);
        double ctheta13 = dotProduct(A1,A3);
        double ctheta14 = dotProduct(A1,A4);
        double ctheta15 = dotProduct(A1,A5);
        double ctheta23 = dotProduct(A2,A3);
        double ctheta24 = dotProduct(A2,A4);
        double ctheta25 = dotProduct(A2,A5);
        double ctheta34 = dotProduct(A3,A4);
        double ctheta35 = dotProduct(A3,A4);
        double ctheta45 = dotProduct(A4,A5);
        
        theta12[t] = acos(ctheta12)*180./pi;
        theta13[t] = acos(ctheta13)*180./pi;
        theta14[t] = acos(ctheta14)*180./pi;
        theta15[t] = acos(ctheta15)*180./pi;
        theta23[t] = acos(ctheta23)*180./pi;
        theta24[t] = acos(ctheta24)*180./pi;
        theta25[t] = acos(ctheta25)*180./pi;
        theta34[t] = acos(ctheta34)*180./pi;
        theta35[t] = acos(ctheta35)*180./pi;
        theta45[t] = acos(ctheta45)*180./pi;
